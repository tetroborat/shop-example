...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('mainapp', '0005_auto_20201011_0939'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.CharField(blank=True, max_length=1024, null=True, verbose_name='Почта')),
                ...
                ('comment', models.TextField(blank=True, null=True, verbose_name='Комментарий к заказазу')),
