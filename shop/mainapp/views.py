...
from .models import Notebook, Smartphone, Category, CartProduct, LatestProducts, Customer, Cart, Order
...
class CheckOut(CartMixin, View):
    ...
    def get(self, request, *args, **kwargs):
        stripe.api_key = 'sk_test_51HkV5RC8ERRHP1cr9Gfjw30sqICAUJd60foldrtuhveqm1BzL06Y7zmQC6NjApQQKe9HURGKOLXtXGSPERefYbmm00PHXhGsAQ'
...
class MakeOrderView(CartMixin, View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            messages.add_message(request, messages.INFO, 'Спасибо за заказ! В ближайшее время наш менеджер свяжется с Вами.')
