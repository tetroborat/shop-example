...
class Notebook(Product):
    ...
    time_wihtout_charge = models.CharField(max_length=255, verbose_name='Время работы аккумулятора')
...
class Smartphone(Product):
    ...
    sd_volume_max = models.CharField(max_length=255, null=True, blank=True,
                                     verbose_name='Максимальный объем встриываемой памяти')
...
class Order(models.Model):
    ...
    address = models.CharField(max_length=1024, verbose_name='Почта', null=True, blank=True)
    ...
    comment = models.TextField(verbose_name='Комментарий к заказазу', null=True, blank=True)
